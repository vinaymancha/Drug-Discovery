...
if __name__ == "__main__":
    for dataset_name in dataset_names:
        ...
        for e in range(1, EPOCH + 1):
            ...
            data_train >> Shuffle(1000) >> Map(organize_features) >> NOP(PrintColType()) >> build_batch >> Map(train_network_batch) >> NOP(Print()) >> Consume()
            ...
            if int(e) % VAL_FREQ == 0:
                ...
                if RMSE_e < best_RMSE:
                    model.save_weights('C:/Users/vinay/Desktop/Drug Discovery/outputs/weights_' + dataset_name + '.h5')
                    best_RMSE = RMSE_e

        print("Calculating errors for test set ...")
        model.load_weights('C:/Users/vinay/Desktop/Drug Discovery/outputs/weights_' + dataset_name + '.h5')
        ...
        writer = WriteCSV('C:/Users/vinay/Desktop/Drug Discovery/outputs/test_errors_' + dataset_name + '.csv')
